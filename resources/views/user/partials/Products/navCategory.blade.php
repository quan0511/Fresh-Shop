    ...
    <div class="offcanvas offcanvas-start offcanvas-collapse w-md-50 " tabindex="-1" id="offcanvasCategory"
        ...
        <div class="offcanvas-body ps-lg-2 pt-lg-0">
                ...
                <ul class="nav nav-category" id="categoryCollapseMenu">
                    <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse"
                        data-bs-target="#categoryFlushOne" aria-expanded="false" aria-controls="categoryFlushOne"><a
                            href="#" class="nav-link">Dairy, Bread
                            & Eggs <i class="feather-icon icon-chevron-right"></i></a>
                        <!-- accordion collapse -->
                    ...
                    <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse"
                        ...
                        aria-controls="flush-collapseThree"> <a href="#" class="nav-link">Fruits & Vegetables
                    ...
                    <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse"
                        ...
                        aria-controls="flush-collapseFour"> <a href="#" class="nav-link">Cold
                            Drinks & Juices <i class="feather-icon icon-chevron-right"></i></a>
                    ...
                    <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse"
                        ...
                        aria-controls="flush-collapseFive"> <a href="#" class="nav-link">Breakfast & Instant
                            Food <i class="feather-icon icon-chevron-right"></i></a>
                    ...
                    <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse"
                        ...
                        <a href="#" class="nav-link">Bakery
                            & Biscuits <i class="feather-icon icon-chevron-right"></i></a>
                    ...
                    <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse"
                        ...
                        aria-controls="flush-collapseSeven"> <a href="#" class="nav-link">Chicken, Meat & Fish
                            <i class="feather-icon icon-chevron-right"></i></a>
            ...
            <div class="mb-8 position-relative">
                ...
                <!-- Banner Content -->
                <!-- Banner Image -->
                <!-- img --><img src="{{asset('{{asset('/assets/images/banner/assortment-citrus-fruits.png"
